...
"      activationFunction 活性化関数。省略なら" DEFAULT_FULLY_CONNECTED_ACTIVATION_FUNCTION "\n"
"  output         出力層\n"
"    設定項目の一覧\n"
"      activationFunction 活性化関数。省略なら" DEFAULT_OUTPUT_ACTIVATION_FUNCTION "\n"
"活性化関数の一覧\n"
"  sigmoid シグモイド関数\n"
